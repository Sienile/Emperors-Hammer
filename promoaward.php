...
Access($_SESSION['EHID'], "awardpromo");
$groupsaccess = AccessGroups($_SESSION['EHID'], "awardpromo");
...
if($_POST['memberid']) {
  ...
  $query = "INSERT INTO EH_Promotion_Recs (For_ID, From_ID, Group_ID, Reason, Type) VALUES('$memberid', '$fromid', '$selGroup', '$reason', 1)";
  $result = mysql_query($query, $mysql_link);
  if($result)
    echo "<p>Promotion award successfully saved, awaiting final approval!</p>\n";
  else
