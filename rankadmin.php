...
elseif($_GET['edit']) {
  ...
  if($rows) {
    $values = mysql_fetch_row($result);
    ?>
<div id="editDiv" class="ajaxForm" title="Edit Rank">
...
?>
  ...
  <div id="response"></div>
  <p>
    <a name="adddialog" onClick="getRankTypes(); $('#add').show()" href="#">
        <span style="color:#6699CC;">Add New Rank</span>
    </a>
  </p>
  <div class="ajaxForm" style="display:none;" id="add" title="Add New Rank">
  ...
  <div id="editdialog" title="Edit Rank" refreshOnShow="true">
  </div>
