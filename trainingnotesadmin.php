...
elseif($_GET['edit']) {
  ...
  if($rows) {
    $values = mysql_fetch_row($result);
    ?>
<div id="editDiv" class="ajaxForm" title="Edit Section">
...
?>
  ...
  <div class="ajaxForm" style="display:none;" id="add" title="Add New Section">
  ...
  <div id="editdialog" title="Edit Section" refreshOnShow="true">
  </div>
