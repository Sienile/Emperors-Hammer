...
elseif($_GET['edit']) {
  ...
  if($rows) {
    $values = mysql_fetch_row($result);
    ?>
<div id="editDiv" class="ajaxForm" title="Edit Unit Type">
...
?>
  ...
  <div class="ajaxForm" style="display:none;" id="add" title="Add New Unit Type">
  ...
  <div id="editdialog" title="Edit Unit Type" refreshOnShow="true">
  </div>
