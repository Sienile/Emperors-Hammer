...
echo "<p>Emperor's Hammer Administration Help</p>\n";
$indent = "&nbsp;&nbsp;&nbsp;&nbsp;";
//Begin Training Functions
echo "<p>Training<br />\n";
if(has_access($_SESSION['EHID'], "acadadmin")) {
  echo $indent."<h3>Training Academies Admin</h3>\n";
  echo "<p>This section</p>";
  }
if(has_access($_SESSION['EHID'], "traincatadmin"))
 echo $indent."<a href=\"trainingcatadmin.php\">Training Categories Admin</a><br />\n";
if(has_access($_SESSION['EHID'], "trainadmin"))
 echo $indent."<a href=\"trainingadmin.php\">Training Course Admin</a><br />\n";
if(has_access($_SESSION['EHID'], "trainawardsadmin"))
 echo $indent."<a href=\"trainingawardsadmin.php\">Training Awards Admin</a><br />\n";
if(has_access($_SESSION['EHID'], "notesadmin"))
 echo $indent."<a href=\"trainingnotesadmin.php\">Training Notes Admin</a><br />\n";
if(has_access($_SESSION['EHID'], "examadmin"))
 echo $indent."<a href=\"trainingexamsadmin.php\">Training Exams Admin</a><br />\n";
if(has_access($_SESSION['EHID'], "examgradeadmin"))
 echo $indent."<a href=\"examadmin.php\">Exam Grading</a><br />\n";
if(has_access($_SESSION['EHID'], "certadmin"))
...
if(has_access($_SESSION['EHID'], "groupadmin"))
  echo $indent."<a href=\"groupadmin.php\">Groups Admin</a><br />\n";
if(has_access($_SESSION['EHID'], "rosteradmin"))
  echo $indent."<a href=\"rosteradmin.php\">Roster Admin</a><br />\n";
if(has_access($_SESSION['EHID'], "positionadmin"))
...
if(has_access($_SESSION['EHID'], "medalapprove"))
  echo $indent."<a href=\"medalapprove.php\">Medals Approval</a><br />\n";
if(has_access($_SESSION['EHID'], "medaladmin"))
...
if(has_access($_SESSION['EHID'], "medalownedadmin"))
...
if(has_access($_SESSION['EHID'], "promoapprove"))
...
if(has_access($_SESSION['EHID'], "compsadmin"))
...
if(has_access($_SESSION['EHID'], "compapproval"))
  echo $indent."<a href=\"compapprove.php\">Approve Competitions</a><br />\n";
if(has_access($_SESSION['EHID'], "compspersonadmin"))
...
if(has_access($_SESSION['EHID'], "battlesadmin"))
...
if(has_access($_SESSION['EHID'], "bsfsubmit"))
  echo $indent."<a href=\"bsfsubmit.php\">BSF Submit</a><br />\n";
if(has_access($_SESSION['EHID'], "bsfapprove"))
  echo $indent."<a href=\"bsfapprove.php\">BSF Approval</a><br />\n";
if(has_access($_SESSION['EHID'], "combatrateadmin"))
  echo $indent."<a href=\"cradmin.php\">Combat Ratings Admin</a><br />\n";
if(has_access($_SESSION['EHID'], "fchgadmin"))
  echo $indent."<a href=\"fchgadmin.php\">FCHG Admin</a><br />\n";
if(has_access($_SESSION['EHID'], "fchgadmin"))
  echo $indent."<a href=\"recalculatefchgcr.php\">Recalculate FCHG/Combat Rating Points</a><br />\n";
if(has_access($_SESSION['EHID'], "sttadmin"))
  echo $indent."<a href=\"sttypeadmin.php\">Stormtrooper Type Admin</a><br />\n";
if(has_access($_SESSION['EHID'], "patchadmin"))
...
echo $indent."Fiction Submit<br />\n";
if(has_access($_SESSION['EHID'], "fictionapprove"))
  echo $indent."Fiction Approval<br />\n";
if(has_access($_SESSION['EHID'], "fictionadmin"))
  echo $indent."Fiction Admin<br />\n";
if(has_access($_SESSION['EHID'], "filesadmin"))
  echo $indent."Files Admin<br />\n";
if(has_access($_SESSION['EHID'], "filesadmin"))
  echo $indent."<a href=\"filescategoryadmin.php\">Files Category Admin</a><br />\n";
if(has_access($_SESSION['EHID'], "historyadmin"))
  echo $indent."History Admin<br />\n";
if(has_access($_SESSION['EHID'], "imgadmin"))
  echo $indent."Images Admin<br />\n";
echo $indent."Image Submission<br />\n";
if(has_access($_SESSION['EHID'], "imgadmin"))
  echo $indent."<a href=\"imgcatadmin.php\">Images Categories</a><br />\n";
if(has_access($_SESSION['EHID'], "nladmin"))
...
if(has_access($_SESSION['EHID'], "siteawardadmin"))
  echo $indent."<a href=\"siteawardadmin.php\">Site Awards Admin</a><br />\n";
if(has_access($_SESSION['EHID'], "skillsadmin"))
